...
/**
 * @notice  Test where there are 2 curves, the lock and the accumulation
 ...
 */
contract GetClaimableRevokedEqTest is GetClaimableNonRevokedTest {
    function deploy() internal virtual override {
        ...
        assertTrue(isLockEq(atp.getGlobalLock(), atp.getAccumulationLock()), "global lock != accumulation lock");
    }
