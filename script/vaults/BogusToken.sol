...
contract Bogus is IERC20Mintable, ERC20, Ownable2Step, ERC20Permit {
    constructor(address _initialOwner) ERC20("Hokus", "Pokus") Ownable(_initialOwner) ERC20Permit("Bogus") {}
